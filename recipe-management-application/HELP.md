...
* The original package name 'com.example.recipe-management-application' is invalid and this project uses 'com.example.recipe_management_application' instead.
